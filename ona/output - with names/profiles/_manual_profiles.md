...
> ✓ **roster locked in this copy** — recruit order: Miya, Neala, Ornella, Svetlana. [mind.md](./mind.md) still takes `{name}` per merge and [body-template.md](./body-template.md) keeps its `{BODY NAME}` slots — fill per recruited follower before merging.
